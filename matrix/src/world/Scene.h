...
namespace MX
{
  ...
  public:
    ...
    // add containers
    MX_API bool push_container(const std::string &name, const std::string &node_to_attach_to = Constants::default_root_name);

    // add objects
    MX_API bool push_object(const std::string &name, const std::string &node_to_attach_to= Constants::default_root_name);
    MX_API bool push_object(
      const std::string &name,
      std::shared_ptr<Model> model,
      std::shared_ptr<Shader> shader,
      const std::string &node_to_attach_to = Constants::default_root_name
    );
    ...
    // add light sources
    MX_API bool push_directional_light(const std::string &name, const std::string &node_to_attach_to = Constants::default_root_name);
    MX_API bool push_point_light(const std::string &name, const std::string &node_to_attach_to = Constants::default_root_name);
    MX_API bool push_spot_light(const std::string &name, const std::string &node_to_attach_to = Constants::default_root_name);
